    ...
    <div className="min-h-screen bg-white font-sans text-neutral-900">
      ...
      <section className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          {html && (
            <article
              className="mt-12 text-base leading-relaxed text-neutral-700 md:text-lg [&_h2]:font-heading [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-neutral-900 [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:scroll-mt-24 md:[&_h2]:text-3xl [&_p]:mt-4 [&_ul]:mt-4 [&_ul]:space-y-2 [&_li]:flex [&_li]:items-start [&_li]:gap-3 [&_li]:before:content-[''] [&_li]:before:mt-2.5 [&_li]:before:h-1.5 [&_li]:before:w-1.5 [&_li]:before:shrink-0 [&_li]:before:rounded-full [&_li]:before:bg-brand-green [&_strong]:text-neutral-900 [&_strong]:font-semibold [&_.tools-grid]:mt-6 [&_.tools-grid]:grid [&_.tools-grid]:gap-4 sm:[&_.tools-grid]:grid-cols-2 [&_.tools-card]:rounded-2xl [&_.tools-card]:bg-neutral-50 [&_.tools-card]:p-6 [&_.tools-card_h3]:font-heading [&_.tools-card_h3]:text-base [&_.tools-card_h3]:font-bold [&_.tools-card_h3]:text-neutral-900 [&_.tools-card_p]:mt-2 [&_.tools-card_p]:text-sm [&_.cta-callout]:mt-8 [&_.cta-callout]:rounded-2xl [&_.cta-callout]:border [&_.cta-callout]:border-brand-green/20 [&_.cta-callout]:bg-brand-green/5 [&_.cta-callout]:p-6 md:[&_.cta-callout]:p-8 [&_.cta-callout_p]:mt-3 [&_.cta-callout_p:first-child]:mt-0 [&_.cta-callout_p:first-child]:font-semibold [&_.cta-callout_p:first-child]:text-neutral-900"
