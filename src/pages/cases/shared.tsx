...
export const CASES: CaseItem[] = [
  ...
  { id: 13, title: 'Сеть кондитерских «Сладкий дом»', category: 'Мерчандайзинг', description: 'Внедрили совмещённый мерчандайзинг в 22 точках — сократили издержки на визиты при сохранении качества выкладки.', photos: [IMG.snacks, IMG.neatRows] },
  { id: 14, title: 'Модернизация точек сети «ЭлектроМир»', category: 'Технический мерчандайзинг', description: 'Заменили устаревшие ценникодержатели на электронные ценники в 8 магазинах сети.', photos: [IMG.merchandiser, IMG.aisleWide] },
  { id: 15, title: 'Дегустационный тур бренда молочной продукции', category: 'BTL услуги + Организация дегустаций', description: 'Провели дегустационный тур по 10 городам — собрали более 3000 обратных связей от покупателей.', photos: [IMG.dairy, IMG.snacks] },
];
